...
extension Item {
    static let sampleItems: [Item] = [
        Item(id: "food_kibble", name: "Kibble", description: "Everyday food for your manul", price: 10, imageName: "food_kibble", type: .food, unlockLevel: 1, isPurchased: true),
        Item(id: "food_fish", name: "Fish", description: "A tasty treat", price: 25, imageName: "food_fish", type: .food, unlockLevel: 1),
